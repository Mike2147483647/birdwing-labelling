<!-- TOC -->
  ...
  * [common_utils](#common_utils)
    ...
    * [enc_labelling](#enc_labelling)
    * [remove_non_marker](#remove_non_marker)
    * [autoenc_predict](#autoenc_predict)
    * [test_acc](#test_acc)
    * [autoenc_label_per_entry](#autoenc_label_per_entry)
    * [autoenc_label_per_marker](#autoenc_label_per_marker)
